...
var CONTRACT_NAME = "wrap.testnet";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            _context.next = 10;
            return new _nearApiJs.Contract(window.walletConnection.account(), 'streaming-r-v2.dcversus.testnet', {
              viewMethods: ['get_account']
            });

          case 10:
            window.roketo_contract = _context.sent;
...
var nearConfig = (0, _config.default)('testnet');
...
function _getBalance() {
  _getBalance = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return window.contract.ft_balance_of({
...
function getStreamDetails() {
  return _getStreamDetails.apply(this, arguments);
...
function _getStreamDetails() {
  _getStreamDetails = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
...
function formSubmit1(_x) {
  return _formSubmit.apply(this, arguments);
}

function _formSubmit() {
  _formSubmit = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(event) {
    var convert;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            convert = _nearApiJs.utils.format.parseNearAmount(convert.toString()).toString();
            _context3.prev = 3;
            _context3.next = 6;
            return window.contract.near_deposit({}, 200000000000000, new BN(convert));
...
function formSubmit2(_x2) {
  return _formSubmit2.apply(this, arguments);
}

function _formSubmit2() {
  _formSubmit2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(event) {
    var invest, months, tokens_per_sec;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            invest = _nearApiJs.utils.format.parseNearAmount(invest.toString()).toString();
            months = document.getElementById('months').value;
            tokens_per_sec = (0, _big.default)(invest).div(2628002 * months).round().toNumber();
            console.log(invest);
            console.log(months);
            console.log(tokens_per_sec);
            _context4.prev = 8;
            _context4.next = 11;
            return window.contract.ft_transfer_call({
...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","./utils":"utils.js","near-api-js":"../node_modules/near-api-js/lib/browser-index.js","big.js":"../node_modules/big.js/big.js","./config":"config.js","bn.js":"../node_modules/bn.js/lib/bn.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
